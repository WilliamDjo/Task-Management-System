...
class LoginTests(unittest.TestCase):
    ...
    def test_invalid_password_login(self):
        ...
        login_data = {"email": "john@example.com", "password": "wrong_password"}
        response = self.app.post(
            "/login", data=json.dumps(login_data), content_type="application/json"
        )
    ...
    def test_inactive_user_login(self):
        ...
        self.app.post(
            "/logout", data=json.dumps(logout_data), content_type="application/json"
        )
...
class LogoutTests(unittest.TestCase):
    ...
    def test_invalid_token_logout(self):
        ...
        logout_data = {"token": "invalid_token"}
        response = self.app.post(
            "/logout", data=json.dumps(logout_data), content_type="application/json"
        )
...
class UpdateUsernameTests(unittest.TestCase):
    ...
    def test_update_username(self):
        ...
        updated_username = {"token": "token", "new_username": "username"}
        response = self.app.put(
            "/update/username",
            data=json.dumps(updated_username),
    ...
    def test_update_invalid_username(self):
        ...
        # Update with new credentials
        updated_username = {"token": token, "new_username": "j"}  # username too short
        response = self.app.put(
            "/update/username",
            data=json.dumps(updated_username),
            content_type="application/json",
...
class UpdateEmailTests(unittest.TestCase):
    ...
    def test_update_username(self):
        ...
        # Update with new credentials
        updated_email = {"token": token, "new_email": "email@email.com"}
        response = self.app.put(
            "/update/email",
            data=json.dumps(updated_email),
            content_type="application/json",
        )
...
class UpdatePasswordTests(unittest.TestCase):
    ...
    def test_update_password(self):
        ...
        # Update with new credentials
        updated_password = {"token": token, "new_password": "password"}
        response = self.app.put(
            "/update/password",
            data=json.dumps(updated_password),
            content_type="application/json",
        )
    ...
    def test_update_invalid_username(self):
        ...
        # Update with new credentials
        updated_password = {"token": token, "new_password": "p"}  # password too short
        response = self.app.put(
            "/update/password",
            data=json.dumps(updated_password),
            content_type="application/json",
    ...
    def test_update_same_username(self):
        ...
        # Update with new credentials
        updated_password = {"token": token, "new_password": "Password123!"}
        response = self.app.put(
            "/update/password",
            data=json.dumps(updated_password),
            content_type="application/json",
...
class UpdateNotifsTests(unittest.TestCase):
    ...
    def test_update_notifs(self):
        ...
        # Update with new credentials
        updated_notifs = {"token": token, "value": value}
        response = self.app.put(
            "/update/notifications",
            data=json.dumps(updated_notifs),
            content_type="application/json",
        )
